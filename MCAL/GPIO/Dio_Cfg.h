...
#define DioConf_LED_PORT_NUM                (Dio_PortType)0 /* PORTA */
#define DioConf_BUTTON_PORT_NUM             (Dio_PortType)1 /* PORTB */

/* DIO Configured Channel ID's */
#define DioConf_LED_CHANNEL_NUM             (Dio_ChannelType)1 /* Pin 0 in PORTA */
#define DioConf_BUTTON_CHANNEL_NUM          (Dio_ChannelType)9 /* Pin 2 in PORTB */
