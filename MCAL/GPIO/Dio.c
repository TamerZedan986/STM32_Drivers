...
void Dio_WriteChannel(Dio_ChannelType ChannelId, Dio_LevelType Level)
{
	...
	if(FALSE == error)
	{
		...
		{
			case 0:	Port_Ptr = &GPIOA_ODR;
		        break;
			case 1:	Port_Ptr = &GPIOB_ODR;
		        break;
			case 2:	Port_Ptr = &GPIOC_ODR;
		        break;
		}
		if(Level == STD_HIGH)
		{
...
Dio_LevelType Dio_ReadChannel(Dio_ChannelType ChannelId)
{
	...
	if(FALSE == error)
	{
		...
		switch(Dio_PortChannels[ChannelId].Port_Num)
		{
		case 0:	PIN_Ptr = &GPIOA_IDR;
		break;
		case 1:	PIN_Ptr = &GPIOB_IDR;
		break;
		case 2:	PIN_Ptr = &GPIOC_IDR;
		break;
		}
...
* Sync/Async: Synchronous
* Reentrancy: Reentrant
* Parameters (in): CPortId - ID of DIO Port.
* Parameters (inout): None
* Parameters (out): None
